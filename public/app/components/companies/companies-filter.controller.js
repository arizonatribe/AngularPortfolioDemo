(function() {
  ...
  .controller('CompaniesFilterController', ['companiesService', 'authStore', 'promiseHandlerService', '_', CompaniesFilterController]);

  /**
   * CompaniesFilterController supports the {@link folio.companies.CompaniesFilterDirective|CompaniesFilterDirective}
   * and responds to interactivity by the user
   * related to retrieving companies or resetting the list of companies
   * @name folio.companies.CompaniesFilterController
   * @class
   ...
   * @constructor
   */
  function CompaniesFilterController(companiesService, authStore, promiseHandlerService, _) {

    /**
     * companies retrieval service
     * @property {object}
     * @name folio.companies.CompaniesFilterController#companiesService
     */
    this.companiesService = _.bindAll(companiesService, 'clear', 'getCompanies');
    /**
     * auth token management service
     * @property {object}
     * @name folio.login.CompaniesFilterController#authStore
     */
    this.authStore = authStore;
    /**
     * promise handling service
     * @property {object}
     * @name folio.login.CompaniesFilterController#promiseHandlerService
     */
     ...
     * @property {boolean}
     * @name folio.companies.CompaniesFilterController#companiesLoading
     */
    this.companiesLoading = false;
  }

  CompaniesFilterController.prototype = {
    constructor: CompaniesFilterController,
    /**
     * Clears all authentication form fields and resets the drop down list for the realms
     * @method folio.login.CompaniesFilterController#resetModel
     */
    resetModel: function() {
     ...
     * @method folio.companies.CompaniesFilterController#fetchCompanies
     */
