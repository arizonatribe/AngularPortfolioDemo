(function() {
  ...
  describe('[Storage Service]', function() {
    ...
    beforeEach(module('folio.unit-testing.storage'));
    ...
    it('Should get an item from storage or default item if it does not exist', function() {
      var testDefaultItem = storageService.getItem('not-in-storage') || fakeData.fakeItems[0];

      expect(testDefaultItem).toEqual(fakeData.fakeItems[0]);
    });
  });
})();
