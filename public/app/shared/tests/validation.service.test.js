(function() {
  ...
  describe('[Validation Service]', function() {
    ...
    beforeEach(module('folio.unit-testing.errorHandlingService'));
    ...
    describe('[getValidations]', function() {
      ...
      it('Should confirm the email validation rules', function() {
        ...
        expect('a@google.com'.match(rule.pattern)).toBeTruthy();
        expect('chalk@google.com'.match(rule.pattern)).toBeTruthy();
        expect('chalk.eraser@google.com'.match(rule.pattern)).toBeTruthy();
        expect('nails@scratched.across.google.com'.match(rule.pattern)).toBeTruthy();
        expect('canadian-person@google.ca'.match(rule.pattern)).toBeTruthy();
        expect('number@99.com'.match(rule.pattern)).toBeTruthy();
        expect('99@99.com'.match(rule.pattern)).toBeTruthy();

        expect('small-suffix@google.c'.match(rule.pattern)).toBeFalsy();
        expect('no-suffix@google'.match(rule.pattern)).toBeFalsy();
        expect('no-suffix@google'.match(rule.pattern)).toBeFalsy();
        expect('where-it-is.at.google.com'.match(rule.pattern)).toBeFalsy();
        expect('at@@google.com'.match(rule.pattern)).toBeFalsy();
        expect('at@at@google.com'.match(rule.pattern)).toBeFalsy();
        expect('@google.com'.match(rule.pattern)).toBeFalsy();
        expect('@google'.match(rule.pattern)).toBeFalsy();
        expect('.@google.com'.match(rule.pattern)).toBeFalsy();
        expect('-@google.com'.match(rule.pattern)).toBeFalsy();
        expect('_@google.com'.match(rule.pattern)).toBeFalsy();
        expect('?@google.com'.match(rule.pattern)).toBeFalsy();
        expect('!@google.com'.match(rule.pattern)).toBeFalsy();
        expect('#@google.com'.match(rule.pattern)).toBeFalsy();
        expect('&@google.com'.match(rule.pattern)).toBeFalsy();
        expect('number@google.c9'.match(rule.pattern)).toBeFalsy();
