(function() {
  ...
  function EventService() {
     ...
     * @property {Array}
     * @name folio.shared.EventService#eventTypes
     * @type {object[]}
     */
    this.eventTypes = [
        {id: 9, name: 'TAB'},
     ...
     * @method folio.shared.EventService#addToEventList
    ...
    this.$get = ['_', function(_) {
       ...
       * @property {object}
       * @name folio.shared.EventService#_
       */
      this._ = _;
      ...
      var $this = this,
           ...
           * @method folio.shared.EventService#getEventKeyCode
           ...
           */
           getEventKeyCode = function($event) {
             ...
             * @method folio.shared.EventService#getEventName
           ...
           getEventName = function($event) {
             ...
             * @method folio.shared.EventService#isEarlierThan
             ...
             * @method folio.shared.EventService#isLaterThan
             * @param {object} $event a standard event object from which to check the event date/time
             * @param {date} time a datetime value against which to validate the event time
             ...
             * @method folio.shared.EventService#isValidEvent
             ...
             * @method folio.shared.EventService#killEvent
